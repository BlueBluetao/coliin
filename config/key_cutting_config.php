...
$key_cutting_config = [
    ...
    'overview' => [
        ...
        'paragraphs' => [
            ...
            'innovation' => [
                ...
                'content' => "We have successively invested and developed the smallest CNC key processing machine in the world over the past several years. The functional, stable, and precise automatic key cutting machines that allow you to duplicate various keys."
            ],
            'technology' => [
                'title' => 'Advanced Technology',
                'content' => "The powerful built-in key database and Intelligent software-guided cutting procedures support all key lost, cut by bitting, find bitting, etc. Xhorse automatic key cutting machines are easy to use and guide you through the key duplicating process step by step."
            ],
            'versatility' => [
    ...
    'products' => [
        ...
        [
            'image' => 'images/key_cutting/k2.png',
        ...
        [
            'image' => 'images/key_cutting/k3.png',

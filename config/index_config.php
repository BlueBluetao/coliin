...
$slider_data = [
    ...
    [
        'image' => asset_url('images/slider/slider-1.png'),
        'subtitle' => '',
    ...
    [
        'image' => asset_url('images/slider/slider-2.png'),
        'subtitle' => '',
...
$services_data = [
    [
        'icon' => asset_url('images/services-icon-1.png'),
    ...
    [
        'icon' => asset_url('images/services-icon-2.png'),

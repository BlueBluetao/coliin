...
<div class="slider" data-show="1" data-arrow="true">
    <div>
        <div class="slider-item">
            <img src="images/slider-1.jpg" alt="" class="">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="slider-content">
                            <h4>WELCOME TO COLIIN...!</h4>
...
<section class="bg-primary no-padding">
    <div class="">
        <div class="flex-row">
            <div class="video-section-left" style="background-image:url('images/home-video-img.jpg');">
                <div class="home-video video-player">
                    <a class="video-play" href="#"><i class="icon ion-md-play"></i></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row flex-row">
            ...
            <div class="col-md-4 text-right align-self-end">
                <a class="text-white coliin-lineheight" href="project.html">View all project <i class="icon ion-md-add-circle-outline"></i> </a>
            </div>
        </div>
